...
* If the Issuer wishes to limit the validity period of an SD-JWT VC it MUST use an `exp` claim, or a `status` claim, or both. The Wallet and the Verifier MUST support both mechanisms.
